 ...
 * @author msoyg
 */
public class MenuStateUIFactory implements GUIFactory {
    ...
    public UIImage createUpArrowIconAnimated(Vector2 position, float rotation, float scale, Color tint){
        return new UpArrowIconAnimated(position, rotation, scale, tint);
    }
}
